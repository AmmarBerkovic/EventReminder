  ...
  <div class="container my-5 bg-light border shadow rounded" style="min-height: 80vh;">
    ...
    <div class="row my-5">
      ...
      <div class="col-4 border shadow rounded">
        <div class="row">
          <div class="col-12">
            <p class="h4 text-center my-3">Search by</p>
          </div>
        </div>
        <div role="separator" class="dropdown-divider"></div>
        <form action="find" method="GET">
          <div class="row">
            ...
            <div class="col-1">
              <input class="form-check-input mt-4" type="radio" name="by" value="name" required>
            </div>
            <div class="col-6">
      ...
      <div class="col-4 border shadow rounded">
        ...
        <form action="show" method="GET">
          <div class="row">
            ...
            <div class="col-1">
              <input class="form-check-input mt-4" type="radio" name="by" value="week" required>
            </div>
            <div class="col-6">
          ...
          <button type="submit"
            class="btn btn-block btn-outline-primary border border-primary font-weight-bold mt-4 my-3">View</button>
        </form>
      </div>
    </div>
